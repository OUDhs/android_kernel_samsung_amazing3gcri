...
static struct setting_table power_on_setting_table_lsi[] = {
	...
	{ DISCTL,    19,  { 0x3B, 0x3A, 0x03, 0x04, 0x02,
						0x08, 0x08, 0x00, 0x08, 0x08,
						0x00, 0x00, 0x00, 0x00, 0x54,
						0x08, 0x08, 0x08, 0x08,
					0x00 },     0 },
	{ PWRCTL,    11,  { 0x0A, 0x00, 0x00, 0x00, 0x00,
				0x00, 0x00, 0x00, 0x15, 0x70,
				0x03,
				0x00, 0x00, 0x00, 0x00, 0x00,
				0x00, 0x00, 0x00, 0x00 },    0 },
	{ VCMCTL,     9,  { 0x00, 0x52, 0x60, 0x00, 0x00,
				0x04, 0x00, 0x00, 0x00,
				0x00, 0x00, 0x00, 0x00,
				0x00, 0x00, 0x00, 0x00,
				0x00, 0x00, 0x00 },    0 },
	/*{ COLMOD,     1,  { 0x77, 0x00, 0x00, 0x00, 0x00,
	...
	{ SRCCTL,     6,  { 0x04, 0x00, 0x08, 0x03, 0x01, 0x00,
				0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
				0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
				0x00, 0x00 },     0 },
	{ IFCTL,      5,  { 0x48, 0x81, 0xF0, 0x02, 0x00,
				0x00, 0x00, 0x00, 0x00, 0x00,
				0x00, 0x00, 0x00, 0x00, 0x00,
	...
	{ GAMMASEL,   1,  { 0x14,
				...
				0x00, 0x00, 0x00, 0x00, 0x00,
				0x00, 0x00, 0x00, 0x00 },     0 },
	{ PGAMMACTL, 16,  { 0x19, 0x00, 0x07, 0x1C, 0x1E,
				0x1C, 0x1B, 0x2B, 0x39, 0x3F,
				0x3F, 0x27, 0x15, 0x00, 0x00, 0x00,
				0x00,
				0x00, 0x00, 0x00 },     0 },
	{ NGAMMACTL, 16,  { 0x00, 0x07, 0x15, 0x27, 0x3F,
				0x3F, 0x39, 0x2B, 0x1B, 0x1B,
				0x1E, 0x1C, 0x07, 0x00, 0x00,
				0x00,
				0x00, 0x00, 0x00, 0x00 },     0 },
	{ GAMMASEL,   1,  { 0x12,
				0x00, 0x00, 0x00, 0x00,	0x00,
				...
				0x00, 0x00, 0x00, 0x00,	0x00,
				0x00, 0x00, 0x00, 0x00 },     0 },
	{ PGAMMACTL, 16,  { 0x1A, 0x06, 0x04, 0x1C, 0x1B,
				0x1C, 0x1C, 0x2A, 0x37, 0x3D,
				0x3D, 0x27, 0x15, 0x00, 0x00,
				0x00,
				0x00, 0x00, 0x00, 0x00 },     0 },
	{ NGAMMACTL, 16,  { 0x06, 0x10, 0x15, 0x27, 0x3D,
				0x3C, 0x38, 0x2A, 0x1C, 0x1B,
				0x1C, 0x1C, 0x04, 0x00, 0x00,
				0x00,
				0x00, 0x00, 0x00, 0x00 },     0 },
	{ GAMMASEL,   1,  { 0x11,
				...
				0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
				0x00, 0x00, 0x00 },     0 },
	{ PGAMMACTL, 16,  { 0x18, 0x06, 0x17, 0x26, 0x23,
				0x23, 0x21, 0x26, 0x35, 0x3B,
				0x3D, 0x27, 0x15, 0x00, 0x00,
				0x00,
				0x00, 0x00, 0x00, 0x00 },     0 },
	{ NGAMMACTL, 16,  { 0x06, 0x12, 0x15, 0x27, 0x3D,
				0x3A, 0x34, 0x26, 0x22, 0x24,
				0x22, 0x26, 0x17, 0x00, 0x00,
				0x00,
				0x00, 0x00, 0x00, 0x00 },     0 },
	{ PASSWD1,    2,  { 0xA5, 0xA5,
				0x00, 0x00, 0x00, 0x00, 0x00,
	...
	{ DISPON,     0,  { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00 },    40 },
/*	{ WRCTRLD,    1,  { 0x2C, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00 },     0 },*/
/*	{ WRBLCTL,    3,  { 0x00, 0x2F, 0x14, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00 },     0 },*/
};
...
/*	Display off*/
	{    0x28, 0, { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x00 }, 40 },

	{    0x10, 0, { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
...
/*	Sleep out */
	{0x11, 0, { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
		0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
...
#define LCDC_HFP        4/*16//3//14*/
#define LCDC_VBP        7/*8*//*change from 8 to 2 //04072012 */
#define LCDC_VPW        4
#define LCDC_VFP        18/*8//2*/
#define LCDC_HPW	4
